...
def drive(cfg, model_path=None, use_joystick=False):
    ...
    usensor=dk.parts.ultrasonic()#####################3asdfasdfasdfsadfsdf
    V.add(usensor,outputs=['sonic_array'])#####sdfffasdgasfffffffffffasdfasdfsdfdsfsfdsfsdfsdfdfdfd
    ...
    V.add(ctr, 
          ...
          threaded=True)
#have to edit ctr to add sonic array########################    
...
#edit to add sonic array##############################    
    ...
    #add tub to save data #added sonic########################################
    inputs=['cam/image_array', 'sonic_array',
            'user/angle', 'user/throttle', 
            'user/mode']
    types=['image_array', 'listfloat',
           'float', 'float',  
           'str']
