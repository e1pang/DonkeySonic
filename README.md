...
Under the 'ForFun' folder are the folders where you don't have to rename to switch "modes." If there is a group continuing this project, a high priority should be rewriting this. There is a readme in that folder.
